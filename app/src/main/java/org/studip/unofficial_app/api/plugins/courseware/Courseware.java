...
public class Courseware
{
    ...
    public Single<CoursewareChapter[]> getChapters(String cid) {
        return routes.getCourseware(cid, null).map(this::getChaptersFromSite);
    }
    
    public CoursewareChapter[] getChaptersFromSite(String s) {
    ...
    public Single<CoursewareSubchapter[]> getSubchapters(String cid, String chapter) {
        return routes.getCourseware(cid, chapter).map(this::getSubchaptersFromSite);
    }
    
    public CoursewareSubchapter[] getSubchaptersFromSite(String s) {
        Document d = Jsoup.parse(s);
    ...
    public Single<CoursewareSection[]> getSections(String cid, String subchapter) {
        return routes.getCourseware(cid, subchapter).map(this::getSectionsFromSite);
    }
    
    public CoursewareSection[] getSectionsFromSite(String s) {
        Document d = Jsoup.parse(s);
    ...
    public Single<CoursewareBlock[]> getBlocks(String cid, String section) {
        return routes.getCourseware(cid, section).map(this::getCoursewareBlocksFromSite);
    }
    
    public CoursewareBlock[] getCoursewareBlocksFromSite(String s) {
        Document d = Jsoup.parse(s);
